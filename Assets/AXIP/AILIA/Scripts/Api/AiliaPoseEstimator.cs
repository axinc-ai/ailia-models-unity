...
public class AiliaPoseEstimator
{
    ...
    **/
    ...
    public const UInt32 AILIA_POSE_ESTIMATOR_ALGORITHM_ACCULUS_HAND             = (5); // 手姿勢検出
    ...
    public const UInt32 AILIA_POSE_ESTIMATOR_ALGORITHM_OPEN_POSE_SINGLE_SCALE   = (12); // 姿勢検出
    ...
    public const UInt32 AILIA_POSE_ESTIMATOR_HAND_KEYPOINT_CNT                  = (21); // 個数
    ...
    public struct AILIAPoseEstimatorKeypoint {
        ...
        public float score;             // この点の検出信頼度。値0.0Fの場合、この点は未検出のため使用できません。
    ...
    public const UInt32 AILIA_POSE_ESTIMATOR_OBJECT_HAND_VERSION=(1); // 構造体フォーマットバージョン
