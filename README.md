...
| Name | Detail | Exported From | Supported Ailia Version |
|:-----------|------------:|:------------:|:------------:|
|[person_reid_baseline_pytorch](/Assets/AXIP/AILIA-MODELS/PersonReID/) | [person_reid_baseline_pytorch](/object_tracking/person_reid_baseline_pytorch/) | Pytorch | 1.2.6 and later |
